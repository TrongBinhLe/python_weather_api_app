...
stations = pd.read_csv("/Users/admin/Documents/Others/python-projects/weather_api_app/data_small/stations.txt",skiprows=17)
...
def all_data(station):
      filename = "/Users/admin/Documents/Others/python-projects/weather_api_app/data_small/TG_STAID" + str(station).zfill(6)+ ".txt"
